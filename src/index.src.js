...
class ReactImageCrop extends Component {
    ...
    _mouseDown(e){
        ...
        let main_block = this.refs.RICC_main_container,
            ...
            mousePosX = e.screenX+document.body.scrollLeft || Math.round(e.touches[0].screenX+document.body.scrollLeft),
            mousePosY = e.screenY+document.body.scrollTop || Math.round(e.touches[0].screenY+document.body.scrollTop);
