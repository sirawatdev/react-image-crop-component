...
class ReactImageCrop extends Component {
    ...
    _mouseDown(e){
        ...
        let main_block = this.refs.RICC_main_container,
            ...
            mousePosX = e.clientX+document.body.scrollLeft || Math.round(e.touches[0].clientX+document.body.scrollLeft),
    ...
    _mouseMove(e){
        if (this.state.status){
            ...
            let main_block = this.refs.RICC_main_container,
                crop_block = this.refs.RICC_crop_block,
                preview_block = this.refs.RICC_crop_preview,
                mousePosX = e.pageX+document.body.scrollLeft || Math.round(e.touches[0].clientX+document.body.scrollLeft),
